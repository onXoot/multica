...
require_config "$config" 'GOOGLE_REDIRECT_URI: http://localhost:3100/login/callback'
...
require_env "$local_env" 'GOOGLE_REDIRECT_URI=http://localhost:3100/login/callback'
